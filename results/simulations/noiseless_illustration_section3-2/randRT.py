...
name_file = 'dataset-rand_rt'

means = np.array([50, 100, 250, 200,  750])/shape #Mean duration of the between event times in ms

relations = [1,2,3,4,1] # to which previous event each event is related (1 is stimulus onset)
